...
venue: "Universty Of Washington,  Computing Fundamentals with Python"        # brief name of host site without address (e.g., "Euphoric State University")
...
helper: ["Rob Fatland", "Jacob Deppen"]     # boxed, comma-separated list of helpers' names, like ["Marlyn Wescoff", "Fran Bilas", "Ruth Lichterman"]
